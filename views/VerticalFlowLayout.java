...
/**
 * Inspired from http://stackoverflow.com/questions/4495094/swing-layout-vertical-flow
 * 
 * This acts a flow manager but in vertical direction. 
 */
public class VerticalFlowLayout implements LayoutManager2
{
    final private Set<Component> components = new HashSet<Component>();
    private int hgap = 0;
    private int vgap = 0;
